...
std::optional<libdnf5::solv::SolvMap> PackageSack::Impl::compute_considered_map(
    ...
    if ((static_cast<bool>(flags & libdnf5::sack::ExcludeFlags::IGNORE_REGULAR_CONFIG_EXCLUDES) ||
        ...
        (!static_cast<bool>(flags & libdnf5::sack::ExcludeFlags::APPLY_VERSIONLOCK) || !versionlock_excludes)) {
        return {};
    }
    ...
    if (static_cast<bool>(flags & libdnf5::sack::ExcludeFlags::APPLY_VERSIONLOCK) && versionlock_excludes) {
